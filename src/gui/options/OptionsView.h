...
class OptionsView: public ui::Window
{
        ...
        ui::DropDown *emSpeed{};
        ui::Textbox *emFrequency{};
        ui::Textbox *emBrightness{};
        ui::Textbox *emAux{};
        ...
        void UpdateEMFrequency(String value, bool isDefocus);
        void UpdateEMBrightness(String value, bool isDefocus);
        void UpdateEMAux(String value, bool isDefocus);
        void EMFrequencyToTextBox(float value);
        void EMBrightnessToTextBox(int value);
        void EMAuxToTextBox(float value);
public:
        OptionsView();
