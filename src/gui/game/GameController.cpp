...
{
#if EMFIELD_DEBUG
        // debug block: drives the EM field self test from the main loop, see
        // debug/EMSelfTest.cpp; compiled out of normal builds
        EMSelfTestTick(*gameModel, *this);
#endif
        gameModel->Tick();
        if(firstTick)
        {
